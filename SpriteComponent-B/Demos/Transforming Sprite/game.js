class Game
{
	...
	init(ASSET_MANAGER, ctx, canvas) 
	{
		...
		this.sprite2 = new Sprite(this.assetManager.getAsset("cirno.png"), 55, 85, 0, 14, 300, 100, this.ctx);
		this.sprite2.setRotation(90); //Rotate by 90 degrees

		this.sprite3 = new Sprite(this.assetManager.getAsset("cirno.png"), 55, 85, 0, 14, 500, 100, this.ctx);
